...
public class BillOrderTem {
	...
	private AccountInvoiceInfo accountInvoiceInfo;
	...
	public AccountInvoiceInfo getAccountInvoiceInfo() {
		return accountInvoiceInfo;
	}
	public void setAccountInvoiceInfo(AccountInvoiceInfo accountInvoiceInfo) {
		this.accountInvoiceInfo = accountInvoiceInfo;
	}
